...
def add_v2_contract(run: Path, commits: dict[str, str], release: str = "0.14.0", *, action: str = "runtime") -> dict[str, str]:
...
class Tests(unittest.TestCase):
    ...
    def test_v2_asset_namespace_rejects_missing_extra_and_unsafe_members(self):
        ...
        prefix = "libreecho-radar-puffin-0.14.0-"
        ...
        for mutation in ("valid", "missing-manifest", "extra-manifest", "extra-file", "symlink", "directory"):
            with self.subTest(mutation=mutation), tempfile.TemporaryDirectory() as temporary:
                ...
                (out/"libreecho-radar-puffin-v0.14.0-build.json").write_text("{}")
